...
public class Colher extends ec3.Produto {
    ...
    public Colher(String nome, String metal, String cor, String serial, double id, double preco, int peso,
      boolean de_sopa)
    {
    ...
    {
        System.out.println(
            "Nome: " + this.nome + " Metal: " + this.metal + " Cor: " + this.cor + " Serial: " + this.id + " preco: " + this.preco + " Peso: " + this.peso + " É de Sopa: "
            + this.de_sopa);
    }
}

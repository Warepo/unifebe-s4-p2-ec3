            ...
            if (escolha != 0) {
                ...
                switch (escolha) {
                    ...
                    case 2:
                        ...
                        Caixa_de_som caixa = new Caixa_de_som("Caixa de Som", marca, cor, serial, id, 0, quantidade,
                            bool);
                    ...
                    case 3:
                        quantidade =
                          Integer.parseInt(JOptionPane.showInputDialog("Quantas cervejas tem dento das caixas ?"));
